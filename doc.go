...
type Config struct {
	...
	// Use request param value for redirect if upstream is a file://. Defaults to redirect_uri
	RedirectParam string `json:"redirect-param" yaml:"redirect-param" usage:"Override name of the redirect request param. Defaults to rd".`
